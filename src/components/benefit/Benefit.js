                    ...
                    <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                        <ImageBackground style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={{uri:Customurldata[0]}}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between',paddingLeft:30}}>
                                    <Text style={{ flex: 1, color: 'blue',fontWeight:"bold", fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas',paddingLeft:80,marginBottom:5 }}
                        ...
                        <ImageBackground resizeMode="cover" style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={{uri:Customurldata[1]}}>
                            <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                    <Text onPress={() => Linking.openURL(url4)} style={{ flex: 1,fontWeight:"bold", color: '#225AE6', fontFamily:'Consolas', backgroundColor: 'transparent' }}>{Customurldata[3]}</Text>
                                </View>
                        ...
                        return (
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between',paddingLeft:30}}>
                                            <Text style={{ flex: 1, color: 'black',fontWeight:"bold", fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas',paddingLeft:80,marginBottom:5 }}
                                            onPress={() => Linking.openURL('https://www.ndnlookup.com')}>https://www.ndnlookup.com </Text>
                                        </View>
                                </ImageBackground>
                            </View>
                        ...
                        return (
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground style={{ width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between',paddingLeft:30}}>
                                            <Text style={{ flex: 1, color: 'blue',fontWeight:"bold", fontSize: 15,backgroundColor: 'transparent',fontFamily:'Consolas',paddingLeft:80,marginBottom:5 }}
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/' + userState.agent.CODE2)} style={{ flex: 1, color: '#225AE6',fontWeight:'bold', fontFamily:'Consolas', backgroundColor: 'transparent' }}>www.medaffordglobal.com/{userState.agent ? userState.agent.CODE2 : ""}</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                                            <Text style={{ flex: 1, color: 'black', backgroundColor: 'transparent',fontWeight:'bold',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/ndn')} style={{ flex: 1, color: '#225AE6',fontWeight:'bold',fontFamily:'Consolas',  backgroundColor: 'transparent' }}>www.medaffordglobal.com/ndn</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/' + userState.agent.CODE2)} style={{ flex: 1,fontWeight:"bold", color: '#225AE6', fontFamily:'Consolas', fontSize: 22, backgroundColor: 'transparent' }}>www.medaffordglobal.com/{userState.agent ? userState.agent.CODE2 : ""}</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text style={{ flex: 1, color: '#225AE6', fontSize: 22,fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>www.medaffordglobal.com/ndn</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/' + userState.agent.CODE2)} style={{ flex: 1, fontWeight:"bold",color: '#225AE6', fontSize: 21,fontFamily:'Consolas',  backgroundColor: 'transparent' }}>www.medaffordglobal.com/{userState.agent ? userState.agent.CODE2 : ""}</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/ndn')} style={{ flex: 1, fontWeight:"bold",color: '#225AE6',fontFamily:'Consolas',  fontSize: 21, backgroundColor: 'transparent' }}>www.medaffordglobal.com/ndn</Text>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                <ImageBackground resizeMode="cover" style={{ flex: 1, width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/' + userState.agent.CODE2)} style={{ flex: 1,fontWeight:"bold", color: '#225AE6', fontFamily:'Consolas', backgroundColor: 'transparent' }}>www.medaffordglobal.com/{userState.agent ? userState.agent.CODE2 : ""}</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                                            <Text style={{ flex: 1, color: 'black', backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
                                        </View>
                            ...
                            <View style={{ marginHorizontal: 2, marginTop: 15 }}>
                                ...
                                <ImageBackground resizeMode="cover" style={{ width: imageWidth, height: imageHeight, borderRadius: 10 }} source={imageSource}>
                                    <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
                                            <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/ndn')} style={{ flex: 1,fontWeight:"bold", color: '#225AE6', fontFamily:'Consolas', backgroundColor: 'transparent' }}>www.medaffordglobal.com/ndn</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                                            <Text style={{ flex: 1, color: 'black',fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
                                        </View>
